...
use crate::{
    ...
    neon_tbl, neon_three_diff, neon_three_same, neon_three_same_extra, neon_three_same_fp,
    neon_two_reg_misc, neon_zip_trn,
};
...
pub(crate) fn decode(word: u32) -> Insn {
    ...
    if matches(word, 0x9f20_c400, 0x0e00_8400) {
        return neon_three_same_extra::decode(word);
    }
